...
<c:forEach items="${requestScope.List}" var="e">
	<div class="gallery">
  <a target="_blank" href="<%=request.getContextPath()%>/images/${e.photo}">
    <img src="<%=request.getContextPath()%>/images/${e.photo}" alt="5Terre" width="600" height="400">
  </a>
  <div class="desc">${e.id}</div>
  <div class="desc">${e.type}</div>
  <div class="desc"><button type="button" id="add" onclick="doAdd();">Add</button>
