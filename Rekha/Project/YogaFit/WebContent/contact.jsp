			...
			<div class="row align-items-center justify-content-between d-flex">
				...
				<nav id="nav-menu-container">
					<ul class="nav-menu">
						...
						<li><a href="#" onclick="document.getElementById('id01').style.display='block'">Login</a></strong></li>
					...
					<form class="form-area contact-form text-right" id="myForm" action="mail.php" method="post">
						<div class="row">
							...
							<div class="col-lg-12">
								...
								<button class="genric-btn primary" style="float: right; width: auto;">Send Message</button>
							</div>
						</div>
					</form>
				</div>
