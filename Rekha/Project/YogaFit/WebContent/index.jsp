		...
		<div class="container-fluid">
			<div class="row fullscreen d-flex align-items-center justify-content-between">
				...
				<div class="banner-content col-lg-6 col-md-6">
					...
					<a href="Signup.jsp" class="primary-btn mt-40">Become a Member</a>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row justify-content-center d-flex align-items-center">
				<div class="col-lg-6 col-md-6 single-feature">
					...
					<div class="text-center">
						<h4 class="mb-10">Basic Preliminary Yoga</h4>
						<p>
				...
				<div class="col-lg-6 col-md-6 single-feature">
					...
					<div class="text-center">
						<h4 class="mb-10">Hath Pranit Pramanpatra</h4>
						<p>
							<a href="#">Book an appointment</a>
						</p>
					</div>
				...
				<div class="col-lg-6 col-md-6 single-feature">
					...
					<div class="text-center">
						<h4 class="mb-10">Advance Guidence Course</h4>
						<p>
							<a href="#">Book an appointment</a>
						</p>
					</div>
