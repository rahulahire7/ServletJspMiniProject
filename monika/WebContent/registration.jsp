...
<div class="signup__container">
  <div class="container__child signup__thumbnail">
    ...
    <div class="thumbnail__content text-center">
      <h1 class="heading--primary">Welcome to Online Courses</h1>
  ...
  <div class="container__child signup__form">
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="text" name="email" id="email" placeholder="Enter Email address"  onblur="validateEmail(this);" required />
      </div>
       ...
       <div class="form-group">
        ...
        <input class="form-control" type="number" name="phone" id="PhoneNo" placeholder="Enter phone number" pattern="(7|8|9)\d{9}" title="Phone no should start with 6 or 7 or 9" required />
      </div>
       <div class="form-group">
        <label for="password">Password</label>
        <input class="form-control" type="password" name="password" id="password" placeholder="********" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"   onkeyup="check()" required />
      </div>
      <div class="form-group">
         <label for="confirm password" class="col-md-3 control-label">Confirm Password</label>
          <div class="form-control">
           <input type="password" id="confirm_password" class="form-control" name="confirm_password" placeholder="********" onkeyup="check()" required/>
            </div>
     </div>
      <div class="form-group">
        <label for="Balance">Balance</label>
        <input class="form-control" type="number" name="Balance" id="Balance" placeholder="Enter balance" required />
      </div>
      ...
      <div class="m-t-lg">
        <ul class="list-inline">
          ...
          <li>
            <a class="signup__link" href="Signup.jsp">I am already a member</a>
          </li>
        </ul>
      </div>
