...
<div class="col span_2_of_4">
				  <div class="contact-form">
				  	...
				  	<h2 class="style">Student Details</h2>
					       ...
					       <form method="post" action="enter_student_details">
					       <input type="hidden" name="action" value="enter_student_details">
					    	<div>
						    	<span><label>Name</label></span>
						    	<span><input name="name" type="text" class="textbox" style="width: 65%;"></span>
						    	
						    </div>
						    <div>
						    	<span><label>Email id</label></span>
						    	<span><input name="email" type="text" class="textbox" style="width: 65%;"></span>
						   ...
						   <div>
						   		<span><input type="submit" value="Add Student Details"></span>
						  </div>
					    </form>
				    </div>
  				</div>		
