...
@WebServlet(urlPatterns = { "/login", "/register", "/takeExam","/takeExam1", "/logout","/TakeAnotherExam","/ProceedFurther","/enter_student_details1" })
	...
	protected void doGet(HttpServletRequest request,
		...
		if (request.getRequestURI().equals(applicationContextPath + "/")) {
			...
			dispatcher.forward(request, response);
				...
				applicationContextPath + "/TakeAnotherExam")) {
			RequestDispatcher dispatcher = request
					.getRequestDispatcher("/WEB-INF/jsps/home2.jsp");
			dispatcher.forward(request, response);
		}
		else if (request.getRequestURI().equals(
			...
			if (request.getSession().getAttribute("user") == null) {
				...
				applicationContextPath + "/takeExam1")) {
			request.getSession().setAttribute("currentExam", null);
			...
			if (request.getSession().getAttribute("user") == null) {
				...
				RequestDispatcher dispatcher = request
						.getRequestDispatcher("/WEB-INF/jsps/quizDetails2.jsp");
				dispatcher.forward(request, response);
			}
		}
		else if (request.getRequestURI().equals(
	...
	protected void doPost(HttpServletRequest request,
		...
		String applicationContextPath = request.getContextPath();
		 if (request.getRequestURI().equals(
				applicationContextPath + "/enter_student_details")) {
			RequestDispatcher dispatcher = request
					.getRequestDispatcher("/WEB-INF/jsps/FinalResult.jsp");
			dispatcher.forward(request, response);
		}
	}
