...
@WebServlet("/exam2")
public class ExamController2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(exam.currentQuestion==0){	
			...
			{   finish=true;
				...
				request.getRequestDispatcher("/WEB-INF/jsps/result1.jsp").forward(request,response);
				
			}
						
		if(finish!=true){
		request.getRequestDispatcher("/WEB-INF/jsps/exam2.jsp").forward(request,response);
		}
