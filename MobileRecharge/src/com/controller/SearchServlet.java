...
public class SearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.println("<th>name</th><th>User name</th><th>password</th><th>Email</th><th>Phone no</th><th>Balance</th>");
		pw.println("</tr><tr>");
		pw.println("<td>"+u.getFname()+"</td><td>"+u.getUname()+"</td><td>"+u.getPassword()+"</td><td>"+u.getEmail()+"</td><td>"+u.getPhone()+"</td><td>"+u.getBalance()+"</td></tr>");
		pw.print("</table>");
